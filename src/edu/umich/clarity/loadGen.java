...
public class loadGen {
    ...
    private static String POISSON_DIG_BG_SAMPLE_FILE="input/dig_load.csv";
    ...
    private static String POISSON_FACE_BG_SAMPLE_FILE="input/face_load.csv";

    private static double poisson_imc_target_mean=2000;
    ...
    private static String POISSON_IMC_BG_SAMPLE_FILE="input/imc_load.csv";
    ...
    private static String POISSON_NER_BG_SAMPLE_FILE="input/ner_load.csv";
    ...
    private static String POISSON_POS_BG_SAMPLE_FILE="input/pos_load.csv";
    ...
    private static String POISSON_CHK_BG_SAMPLE_FILE="input/chk_load.csv";
    ...
    private static String POISSON_STEMMER_BG_SAMPLE_FILE="input/stemmer_load.csv";
    ...
    private static String POISSON_ASR_BG_SAMPLE_FILE="input/asr_load.csv";
    ...
    private static String POISSON_GMM_BG_SAMPLE_FILE="input/gmm_load.csv";
...
//        LOG.info("the number of queries will be generated is " + num_client);
    ...
    public static void main(String[] args) {
        ...
        client.genPoissonSamples(poisson_target_mean, 20000, POISSON_TARGET_SAMPLE_FILE);
        client.genPoissonSamples(poisson_bg_mean, 20000, POISSON_BG_SAMPLE_FILE);
        
        client.genPoissonSamples(poisson_dig_target_mean, 20000, POISSON_DIG_TARGET_SAMPLE_FILE);
        client.genPoissonSamples(poisson_dig_bg_mean, 20000, POISSON_DIG_BG_SAMPLE_FILE);

        client.genPoissonSamples(poisson_face_target_mean, 20000, POISSON_FACE_TARGET_SAMPLE_FILE);
        client.genPoissonSamples(poisson_face_bg_mean, 20000, POISSON_FACE_BG_SAMPLE_FILE);

        client.genPoissonSamples(poisson_imc_target_mean, 20000, POISSON_IMC_TARGET_SAMPLE_FILE);
        client.genPoissonSamples(poisson_imc_bg_mean, 20000, POISSON_IMC_BG_SAMPLE_FILE);

        client.genPoissonSamples(poisson_ner_target_mean, 20000, POISSON_NER_TARGET_SAMPLE_FILE);
        client.genPoissonSamples(poisson_ner_bg_mean, 20000, POISSON_NER_BG_SAMPLE_FILE);
        
        client.genPoissonSamples(poisson_pos_target_mean, 20000, POISSON_POS_TARGET_SAMPLE_FILE);
        client.genPoissonSamples(poisson_pos_bg_mean, 20000, POISSON_POS_BG_SAMPLE_FILE);
        
        client.genPoissonSamples(poisson_chk_target_mean, 20000, POISSON_CHK_TARGET_SAMPLE_FILE);
        client.genPoissonSamples(poisson_chk_bg_mean, 20000, POISSON_CHK_BG_SAMPLE_FILE);
        
        client.genPoissonSamples(poisson_stemmer_target_mean, 20000, POISSON_STEMMER_TARGET_SAMPLE_FILE);
        client.genPoissonSamples(poisson_stemmer_bg_mean, 20000, POISSON_STEMMER_BG_SAMPLE_FILE);
        
        client.genPoissonSamples(poisson_asr_target_mean, 20000, POISSON_ASR_TARGET_SAMPLE_FILE);
        client.genPoissonSamples(poisson_asr_bg_mean, 20000, POISSON_ASR_BG_SAMPLE_FILE);
        
        client.genPoissonSamples(poisson_gmm_target_mean, 20000, POISSON_GMM_TARGET_SAMPLE_FILE);
        client.genPoissonSamples(poisson_gmm_bg_mean, 20000, POISSON_GMM_BG_SAMPLE_FILE);

//Rodinia
        client.genPoissonSamples(poisson_backprop_mean, 20000, POISSON_BACKPROP_SAMPLE_FILE);
        client.genPoissonSamples(poisson_bfs_mean, 20000, POISSON_BFS_SAMPLE_FILE);
        client.genPoissonSamples(poisson_cfd_mean, 40000, POISSON_CFD_SAMPLE_FILE);
        client.genPoissonSamples(poisson_dwt2d_mean, 20000, POISSON_DWT2D_SAMPLE_FILE);
        client.genPoissonSamples(poisson_gaussian_mean, 20000, POISSON_GAUSSIAN_SAMPLE_FILE);
        client.genPoissonSamples(poisson_heartwall_mean, 20000, POISSON_HEARTWALL_SAMPLE_FILE);
        client.genPoissonSamples(poisson_hotspot_mean, 20000, POISSON_HOTSPOT_SAMPLE_FILE);
        client.genPoissonSamples(poisson_hybridsort_mean, 20000, POISSON_HYBRIDSORT_SAMPLE_FILE);
        client.genPoissonSamples(poisson_kmeans_mean, 20000, POISSON_KMEANS_SAMPLE_FILE);
        client.genPoissonSamples(poisson_lavaMD_mean, 20000, POISSON_LAVAMD_SAMPLE_FILE);
        client.genPoissonSamples(poisson_leukocyte_mean, 20000, POISSON_LEUKOCYTE_SAMPLE_FILE);
        client.genPoissonSamples(poisson_lud_mean, 40000, POISSON_LUD_SAMPLE_FILE);
        client.genPoissonSamples(poisson_mummergpu_mean, 20000, POISSON_MUMMERGPU_SAMPLE_FILE);
        client.genPoissonSamples(poisson_myocyte_mean, 20000, POISSON_MYOCYTE_SAMPLE_FILE);
        client.genPoissonSamples(poisson_nn_mean, 20000, POISSON_NN_SAMPLE_FILE);
        client.genPoissonSamples(poisson_nw_mean, 20000, POISSON_NW_SAMPLE_FILE);
        client.genPoissonSamples(poisson_particlefilter_mean, 20000, POISSON_PARTICLEFILTER_SAMPLE_FILE);
        client.genPoissonSamples(poisson_pathfinder_mean, 20000, POISSON_PATHFINDER_SAMPLE_FILE);
        client.genPoissonSamples(poisson_pathfinderPIN_mean, 20000, POISSON_PATHFINDERPIN_SAMPLE_FILE);
